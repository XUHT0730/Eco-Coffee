      ...
      <div class="container-fluid">
        ...
        >
          <div class="navbar-nav me-auto mb-2 mb-lg-0">
            <RouterLink to="/admin/products" class="nav-item nav-link"
              >產品</RouterLink
            >
            <RouterLink to="/admin/orders" class="nav-item nav-link"
              >訂單</RouterLink
            >
            <RouterLink to="/admin/coupons" class="nav-item nav-link"
              >優惠券</RouterLink
            >
            <RouterLink to="/admin/article" class="nav-item nav-link"
              >貼文</RouterLink
            >
            <router-link to="/" class="nav-item nav-link">前台頁面</router-link>
            <a href="#" @click.prevent="logOut" class="nav-item nav-link"
              >登出</a
            >
          </div>
        </div>
