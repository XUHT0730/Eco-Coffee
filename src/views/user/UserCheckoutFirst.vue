    ...
    <div class="row justify-content-center">
      <div class="col-md-10">
        <nav class="navbar navbar-expand-lg navbar-light px-0">
          ...
          >
            <li
              class="me-md-6 me-3 position-relative custom-step-line text-primary fw-bold"
            >
              <i
                class="bi bi-check2-circle d-md-inline d-block text-center"
              ></i>
            ...
            <li>
              <i
                class="bi bi-exclamation-circle d-md-inline d-block text-center"
              ></i>
    ...
    <div class="row flex-row-reverse justify-content-center pb-5">
      <div class="col-md-5">
        <div class="border p-4 mb-4 border-dark">
          ...
          <table
            class="table mt-4 border-top border-bottom text-muted border-dark"
          >
            <tbody>
              <tr>
      ...
      <div class="col-md-5">
        <VeeForm ref="form" v-slot="{ errors }" @submit="createOrder">
          ...
          >
            <router-link to="/cart" class="mt-5"
