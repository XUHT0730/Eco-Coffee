    ...
    <section class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-md-6 align-items-center">
          ...
          class="img-fluid mb-3 object-fit-cover" width="525" :alt="product.title">
        </div>
        <article class="col-md-5">
          <h2 class="fw-bold mb-3">{{ product.title }}</h2>
          <h5><span class="badge bg-primary mb-2">{{product.category}}</span></h5>
              ...
              <div class="col-6">
                ...
                <button class="btn btn-danger w-100" type="button"
                 ...
                 <span v-if="trackList.includes(product.id)">
                  ...
                  <span v-else><i class="bi bi-heart text-white"></i></span>
                   加入收藏
                </button>
              </div>
              <div class="col-6">
